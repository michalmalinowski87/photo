...
importScripts(
  "https://cdn.jsdelivr.net/npm/browser-image-compression@2.0.2/dist/browser-image-compression.umd.js"
);
...
const THUMBNAIL_QUALITY = 0.2; // Quality limit reached - maintaining at 0.20
...
async function generateThumbnail(fileData, fileName, fileType) {
  try {
    ...
    const imageCompressionFn =
      typeof imageCompression !== "undefined" ? imageCompression : self.imageCompression;
