      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            We could not load this gallery. Please try again later.
          </p>
          <div className="flex flex-wrap justify-center gap-3">
            <button
              type="button"
              onClick={() => void refetchGallery()}
              className="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-white rounded hover:opacity-90"
            >
              Try again
            </button>
            <button
