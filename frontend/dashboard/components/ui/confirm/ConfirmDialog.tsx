  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} showCloseButton={true} className="max-w-2xl">
      <div className="p-6">
        ...
        {suppressKey && (
          <div className="mb-6 p-4 bg-photographer-background dark:bg-gray-800/50 rounded-lg border border-gray-400 dark:border-gray-700">
            <label
                ...
                <div
                  className={`w-5 h-5 rounded border-2 transition-all duration-200 flex items-center justify-center ${
                    suppressChecked
                      ...
                      : `bg-white border-photographer-border dark:bg-gray-700 dark:border-gray-600${loading ? "" : " group-hover:border-photographer-accent dark:group-hover:border-photographer-accent"}`
                  }`}
                >
                  {suppressChecked && (
