            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 p-4 bg-blue-50 dark:bg-blue-500/10 rounded-lg border border-blue-200 dark:border-blue-500/30">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Klient otrzyma link do galerii i będzie mógł przeglądać zdjęcia, wybierać
                    te, które mu się podobają, i zatwierdzać swój wybór.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 bg-yellow-50 dark:bg-yellow-500/10 rounded-lg border border-yellow-200 dark:border-yellow-500/30">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Jeśli klient popełni błąd lub zmieni zdanie, może poprosić o możliwość
                    zmiany wyboru. Otrzymasz powiadomienie i będziesz mógł zatwierdzić lub
                    odrzucić prośbę.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 bg-purple-50 dark:bg-purple-500/10 rounded-lg border border-purple-200 dark:border-purple-500/30">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Prześlij przetworzone, finalne zdjęcia do zlecenia. Gdy wszystko będzie
                    gotowe, wyślij klientowi finalny link do pobrania zdjęć.
                  </p>
                </div>
              </div>
            </div>
