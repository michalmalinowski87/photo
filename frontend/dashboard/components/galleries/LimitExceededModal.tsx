...
export const LimitExceededModal: React.FC<LimitExceededModalProps> = ({
	...
	const handleUpgrade = async () => {
		if (!nextTierPlan || !nextTierPriceCents || !nextTierLimitBytes) {
			showToast('error', 'Błąd', 'Nie można zaktualizować planu. Brak informacji o następnym planie.');
			return;
		}
	...
	const nextTierGB = nextTierLimitBytes ? (nextTierLimitBytes / (1024 * 1024 * 1024)).toFixed(1) : '';
