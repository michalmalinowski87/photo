...
export default function GallerySettings() {
	...
	const checkDeliveredOrders = async (): Promise<void> => {
		if (!galleryId) return;
	...
	const handleUpdateSettings = async (): Promise<void> => {
		...
		try {
			...
			if (settingsForm.clientPassword && settingsForm.clientEmail) {
				await api.galleries.updateClientPassword(galleryId as string, settingsForm.clientPassword, settingsForm.clientEmail);
			}
