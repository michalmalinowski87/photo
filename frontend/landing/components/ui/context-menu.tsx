...
function ContextMenuSubTrigger({ ref, className, inset, children, ...props }: React.ComponentPropsWithoutRef<typeof ContextMenuPrimitive.SubTrigger> & { ref?: React.Ref<React.ElementRef<typeof ContextMenuPrimitive.SubTrigger>>; inset?: boolean }) {
  return (
...
function ContextMenuItem({ ref, className, inset, ...props }: React.ComponentPropsWithoutRef<typeof ContextMenuPrimitive.Item> & { ref?: React.Ref<React.ElementRef<typeof ContextMenuPrimitive.Item>>; inset?: boolean }) {
  return (
...
function ContextMenuLabel({ ref, className, inset, ...props }: React.ComponentPropsWithoutRef<typeof ContextMenuPrimitive.Label> & { ref?: React.Ref<React.ElementRef<typeof ContextMenuPrimitive.Label>>; inset?: boolean }) {
  return (
