...
const PasswordProtectionPage = () => {
  ...
  // posthog.capture(PostHogActions.landing.featurePageView, { landing_feature_page: "password-protection" });
            ...
            <div className="flex items-center justify-center gap-x-4 mt-8">
              <Button size="sm" asChild>
                <Link 
                  ...
                  data-ph-property-landing_feature_page="password-protection"
                >
                  Rozpocznij za darmo
                </Link>
              </Button>
